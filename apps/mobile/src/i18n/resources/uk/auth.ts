export const authUk = {
  ...
  verifyEmail: {
    ...
    promptTitle: 'Підтвердіть електронну пошту',
    ...
    backToSignIn: 'Назад до входу',
    promptBody:
      'Ми надіслали посилання для підтвердження на {{email}}. Відкрийте його, щоб підтвердити обліковий запис.',
    promptBodyFallback: 'вашу електронну пошту',
    resend: 'Надіслати лист підтвердження ще раз',
    resending: 'Надсилання...',
    resendSuccess: 'Лист підтвердження надіслано. Перевірте вхідні.',
