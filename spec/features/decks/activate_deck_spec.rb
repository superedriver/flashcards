...
describe "activate/deactivate_deck", type: :feature do
  ...
  describe "authorized user" do
    ...
    scenario "activate deck" do
      visit decks_path
      click_link(I18n.t("buttons.activate"), href: "/decks/#{@deck1.id}/activate")

      expect(page).to have_link(
                          I18n.t("buttons.deactivate"),
                          href: "/decks/#{@deck1.id}/deactivate")
    ...
    scenario "activate another deck" do
      visit activate_deck_path(@deck1)
      visit decks_path
      click_link(I18n.t("buttons.activate"), href: "/decks/#{@deck2.id}/activate")

      expect(page).to have_link(
                          I18n.t("buttons.deactivate"),
                          href: "/decks/#{@deck2.id}/deactivate")
      expect(page).not_to have_link(
                              I18n.t("buttons.activate"),
                              href: "/decks/#{@deck2.id}/activate")
      expect(page).to have_link(
